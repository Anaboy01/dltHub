...
const Footer = () => {
  ...
  const handleSubscribeSubmit = (e) => {
    ...
    axios
      .post("https://dev-studio-phi.vercel.app/api/v1/newsLetter/subscribe", { emailAddress: email })
      .then((response) => {
  ...
  return (
    <footer className=" w-full border-t-[#3BF500] border-t-[1px] lg:h-[582px] px-[78px] pb-[31px] pt-[84px] relative bg-[#000000] bg-footer-bg background font-poppins overflow-hidden">
      <div className="flex flex-col items-center gap-[50px] md:items-start lg:flex-row lg:gap-[187px]">
      <div className="flex flex-col items-center gap-[50px]  md:flex-row lg:gap-[187px]">
      <div className="flex flex-col items-center gap-[20px] w-[223.03px]">
        ...
        <div className="w-[310px] flex text-center flex-col gap-3 md:text-left">
        ...
        <div className="flex flex-col justify-start  items-center md:items-start gap-[32px]">
          <h1 className="text-[#FEA650] font-poppins text-center text-[16px] font-medium">
            Subscribe to our newsletter
          </h1>
          <form onSubmit={handleSubscribeSubmit} className="flex flex-col items-center md:flex-row">
            <input
              type="text"
      ...
      <div className="w-[300px] h-[300px] relative bottom-[-80px]  flex items-center justify-center md:absolute md:bottom-[-50px] right-[-10px] lg:w-[478px] lg:h-[478px] ">
        <Lottie
